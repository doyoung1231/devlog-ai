...
![DevLog AI](https://img.shields.io/badge/DevLog_AI-v0.1-orange?style=flat-square)
![Powered by Claude](https://img.shields.io/badge/Powered_by-Claude_Sonnet-blueviolet?style=flat-square)
...
| 인증 & DB | Supabase (Google OAuth + 이메일/비밀번호) |
...
- [Supabase](https://supabase.com) 프로젝트 (히스토리 및 인증용)

### 설치

```bash
git clone https://github.com/your-username/devlog-ai.git
cd devlog-ai
npm install
```
...
*DevLog AI v0.1 — Powered by Claude · 개발자를 위해 만들어졌습니다*
